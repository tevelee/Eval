#
#  Be sure to run `pod spec lint Eval.podspec' to ensure this is a
...
It evaluates expressions at runtime, with operators and data types you define.
  ...
  # Or just: s.author    = "Laszlo Teveli"
  # s.authors            = { "Laszlo Teveli" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Laszlo Teveli"
